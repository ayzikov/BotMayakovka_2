...
async def about_project_handler(message: Message):
    ...
    text = 'Библиотека имени Маяковского сделала чат-бот «Название бота» к 130-летию Владимира Маяковского.' \
           ...
           'Бот «Маяковский в Петрограде» подробно расскажет из них, поделится интересными историями, воспоминаниями современников поэта и стихотворениями.' \
           ...
           'Мы поддерживаем интерес к жизни и творчеству поэта, художника, актера и деятеля эпохи авангарда.' \
           'И, конечно, стремимся разделить его с вами!'
