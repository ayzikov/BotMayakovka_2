...
async def main_menu_handler(message: Message, state: FSMContext):
    ...
    if location_number == 13:
        ...
        text = 'В 1912 году девятнадцатилетний Владимир Маяковский впервые приехал в Санкт-Петербург. Чтобы пройтись вместе с поэтом по Петербургу, Петрограду и Ленинграду, нажмите на кнопку «Прогулка по городу». Не забудьте взять наушники, чтобы послушать аудиогид.\n\n' \
               'Хотите больше узнать о проекте и ближе познакомиться с библиотекой имени Маяковского — нажимайте на кнопку «О проекте»'
